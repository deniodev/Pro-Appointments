        ...
        <div>
          <div className='lg:w-[570px'>
            ...
            <p className='text__para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
              Fugiat eligendi provident ullam odit neque dolores hic non eos ad 
              necessitatibus aspernatur ea saepe ab reiciendis id, quo suscipit corrupti eveniet.
            </p>
        ...
        <div className="flex items-center justify-between flex-col lg:flex-row">
          ...
          <div className="xl:w-[670px]">
            ...
            <ul className="pl-4">
              ...
              <li className="text__para">3. View our physicians who are accepting new patients, use the online
